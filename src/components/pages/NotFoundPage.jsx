...
const ErrorPage = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-950 text-white overflow-hidden">
            ...
            <main className="relative flex-1 flex flex-col items-center justify-center px-6 text-center z-10 py-20">
                
                <h1 className="text-[12rem] md:text-[20rem] font-extrabold text-slate-800/20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none z-0 tracking-tighter pointer-events-none">
                    404
                </h1>
